                ...
                <div class="mb-1">
                    ...
                    <form id="contacto" method="POST" action="validar.php"> <!-- envia los datos de login a validar -->
                        ...
                        <div class="mb-4">
                            ...
                            <input type="email" class="form-control" name="txtCorreo" id="txtCorreo" placeholder="ej: erick.chinchin@gmail.com" value="<?php echo $correo; ?>" required> <!-- imprime la variable en el campo-->
